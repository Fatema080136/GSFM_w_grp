...
public final class CPedestrianGenerator_grp extends IBaseAgentGenerator<IBaseRoadUser>
{
    ...
    */
    ...
    //private final List<CInputFormat> m_inputdata; // without pedestrian social group
    ...
    public CPedestrianGenerator_grp(@Nonnull final InputStream p_stream, final CEnvironment p_environment, final List<CInputFormat_grp> p_inputdata ) throws Exception
    {
        super(
                // input ASL stream
                p_stream,
    ...
    public final IBaseRoadUser generatesingle( @Nullable final Object... p_data )
    {
        ...
        //CInputFormat l_ped = m_inputdata.remove(0);//without pedestrian social group
        ...
        /* //without considering pedestrian social group
