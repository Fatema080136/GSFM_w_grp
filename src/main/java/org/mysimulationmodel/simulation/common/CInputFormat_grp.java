...
public class CInputFormat_grp
{
    ...
    public CInputFormat_grp(int p_scenario_id, String p_roaduser_id, double p_startx_axis, double p_starty_axis, double p_endx_axis,
                        double p_endy_axis, double p_speed, double p_max_speed, int p_numberofcycle, int p_start_cycle, int p_type,
                        int p_groupsize, int p_groupnumber, int p_groupid )
    {
        ...
        m_type = p_type;
        m_groupsize = p_groupsize;
        m_groupnumber = p_groupnumber;
        m_groupid = p_groupid;
    }
}
