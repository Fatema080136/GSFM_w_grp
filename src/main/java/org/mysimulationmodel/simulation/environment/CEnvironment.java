...
public class CEnvironment extends JPanel implements IEnvironment
{
    ...
    private Map<String,IBaseRoadUser> m_pedestrianbyname = new HashMap<>();
    private static final int m_pixelpermeter = 5;
    ...
    public CEnvironment()
    {
       ...
       setDoubleBuffered( true );
        ...
        m_width = 100*m_pixelpermeter;//600;//x axis
    ...
    public void initialPedestrian(IBaseRoadUser p_pedestrian ) {
        m_pedestrian.add( p_pedestrian );
        m_pedestrianbyname.put( p_pedestrian.getname(),p_pedestrian);
    }
    ...
    public IBaseRoadUser getPedestrainyName( String p_name)
    {
        return m_pedestrianbyname.get(p_name);
    }
